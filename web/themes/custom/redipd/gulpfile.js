...
var sassDocOptions = {
  ...
  description: 'Sassdoc for redipd theme',
};
...
gulp.task('default', function () {
  ...
  console.log('gulp ' + 'watch -h'.cyan + ' localhost'.green + '      ' + '# To configure hosts as redipd.local.'.grey);
  console.log('');
});
...
gulp.task('sasslint', function () {
  return gulp.src(srcAssets.styles + '**/*.s+(a|c)ss')
    .pipe(sassLint({
      options: {
        configFile: 'redipd.sass-lint.yml'
      }
    }))
